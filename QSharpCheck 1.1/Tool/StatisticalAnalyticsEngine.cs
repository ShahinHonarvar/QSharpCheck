...
namespace QSharpCheck
{
    public static class StatisticalAnalyticsEngine
    {
        ...
        public static bool AnalyseMeasurementResultOfTeleportation(double theta1, double phi1, double theta2,
            double phi2, double theta3, double phi3, long mean, double significanceLevel, int numberOfMeasurements)
        {
            var theta = theta1 - phi1 != 0.0
                ? theta1
                : theta2 - phi2 != 0.0
                    ? theta2
                    : theta3 - phi3 != 0.0
            ...
            int numberOfMeasurements, double minOfDestinationTheta, double maxOfDestinationTheta)
        {
            ...
            var lower = Bn.QBinom(significanceLevel / 200.0, numberOfMeasurements, p2, true);
            var upper = Bn.QBinom(significanceLevel / 200.0, numberOfMeasurements, p1, false);

            return lower <= mean && mean <= upper;
        }
            ...
            List<long> measurementListQ2, double significanceLevel)
        {
            ...
            double sum1 = measurementListQ1.Sum();
            double sum2 = measurementListQ2.Sum();
            ...
            double df = measurementListQ1.Count + measurementListQ2.Count - 2;
            ...
            return Math.Abs(calculateT) <= table[significanceLevel / 100.0];
        }

        public static bool EqualityComparison(bool b1, bool b2, bool r1, bool r2)
        {
            return r1 == b1 && r2 == b2;
        }
        ...
        public static void printAll_AssertTeleported(double theta1, double phi1, double theta2, double phi2,
            double theta3, double phi3, long numberOfTestCases,
            long numOfExperiments, long numberOfMeasurements, int confidenceLevel, string propertyName, bool h0, int i)
        {
            Console.WriteLine(
                "\n╒═══════════════════════════════════════════════════════╕");
            ...
            else
            {
                ...
                Console.WriteLine($"  θ = {ToDegree(theta3)} and φ = {ToDegree(phi3)}");
            }
        ...
        public static void printAll_AssertEqual(double theta1, double phi1, double theta2, double phi2,
            long numberOfTestCases,
            long numOfExperiments, long numberOfMeasurements, int confidenceLevel, string propertyName, bool h0, int i)
        {
            Console.WriteLine(
